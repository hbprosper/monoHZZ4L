...
! --------------------------------------------------------------------------
! 4) Process
HiggsSM:ff2Hff(t:ZZ) = on	   ! Higgs boson prod. via ZZ fusion
HiggsSM:ff2Hff(t:WW) = on	   ! Higgs boson prod. via WW fusion
25:m0        = 125.0		   ! (GeV) Higgs boson mass
25:onMode    = off		   ! all decays off
25:onIfMatch = 23 23		   ! decay to ZZ

23:onMode    = off                 ! all Z decays off
23:onIfAny   = 13 15	           ! Z to mu-mu+ or tau-tau+

15:onMode   = off
15:onIfAny  = 13                   ! tau to mu
